...
var xAxis;
var root;
function CurrentLineChart({ selectedBmsIndex }) {
    ...
    if (
      ...
      if (!chartDefined) {
        ...
        for (let i = 0; i < 1; i++) {
          ...
          let lastValue = lastDataItem?.get("valueY");
          let newValue = current[current.length - 1];
          // let newValue =
          //   temp[`bms ${selectedBmsIndex}`] === undefined
          //     ? "p"
          //     : temp[`bms ${selectedBmsIndex}`][
          //         temp[`bms ${selectedBmsIndex}`].length - 1
          //       ][i] === undefined
          //     ? "-"
          //     : temp[`bms ${selectedBmsIndex}`][
          //         temp[`bms ${selectedBmsIndex}`].length - 1
  ...
  }, [voltage, temp, chartDefined, selectedBmsIndex, current]);

  return (
    <div>
      <div>
        <h2>Current v/s Time</h2>
      </div>
